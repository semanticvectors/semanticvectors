...
public class IndexFilePositions {
  ...
  public static void main(String[] args) {
    ...
    if (FlagConfig.porterstemmer) INDEX_DIR = new File("stemmed_positional_index");	
    //allow for the specification of a directory to index to
    if (FlagConfig.indexRootDirectory.length() > 0) INDEX_DIR = new File(FlagConfig.indexRootDirectory+INDEX_DIR.getName());
    }
    if (INDEX_DIR.exists()) {
