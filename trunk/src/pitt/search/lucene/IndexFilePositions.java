...
/** Index all text files under a directory. This class makes minor modifications to org.apache.lucene.demos.IndexFiles 
 * */
public class IndexFilePositions {
  ...
  public static void main(String[] args) {
    String usage = "java pitt.search.lucene.IndexFilePositions <root_directory> [optional stoplist file]";
    if (args.length == 0) {
  ...
  static void indexDocs(IndexWriter writer, File file)
    ...
    if (file.canRead()) {
      if (file.isDirectory()) {
        ...
        try {
        	//use FilePositionDoc rather than FileDoc such that term positions are indexed also
